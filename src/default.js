...
export const colors = {
  ...
  grey: ['#F2F2F2', '#E6E6E6', '#CCCCCC', '#B3B3B3', '#999999', '#808080', '#666666', '#4D4D4D', '#333333', '#1A1A1A'],

  greenGrey: ['#EDF2EE', '#DAE5DA', '#B4CCB4', '#96B297', '#7A997C', '#618062', '#406B42', '#2B572E', '#173B1A', '#002603']
}
